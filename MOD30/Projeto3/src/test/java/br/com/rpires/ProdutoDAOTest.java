...
public class ProdutoDAOTest {
	...
	// id, codigo, nome, descrição, valor, peso
	private Produto criarProduto(String codigo) throws TipoChaveNaoEncontradaException, DAOException {
		...
		produto.setPeso(new BigDecimal("5.500"));
	...
	public void alterarProduto()
		...
		produto.setNome("monitor AOC");
		produto.setDescricao("27 pol");
		produto.setValor(new BigDecimal("799.00"));
		produto.setPeso(new BigDecimal("5.500"));
		produtoDao.alterar(produto);
		Produto produtoBD = this.produtoDao.consultar(produto.getCodigo());
		assertNotNull(produtoBD);
		Assert.assertEquals("monitor AOC", produtoBD.getNome());
